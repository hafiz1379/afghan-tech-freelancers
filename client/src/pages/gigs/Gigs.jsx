        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between flex-col sm:flex-row sm:pr-2 ">
            <div className="flex flex-col md:flex-row w-full gap-3 text-gray-500 font-normal lg:mb-0 sm:px-1">
              ...
              <input type="number" placeholder="min" ref={minRef} className="p-1 outline-none border-gray-500 border" />
              <input type="number" placeholder="max" ref={maxRef} className="p-1 outline-none border-gray-500 border" />
              <button
                onClick={apply}
                className="bg-green-500 text-white font-medium border-none px-2 py-1 rounded-md cursor-pointer hover:bg-green-600"
              >
                Apply
              </button>
            </div>
            <div className="flex items-center gap-2 relative">
              ...
              <span className="font-medium cursor-pointer text-nowrap" onClick={() => setOpen(!open)}>
              ...
              {open && (
                <div className="p-2 bg-white rounded-sm border border-gray-300 absolute top-8 right-0 text-gray-600">
                  ...
                  <span onClick={() => reSort("sales")} className="flex">
                    Popular
                  </span>
                </div>
              )}
